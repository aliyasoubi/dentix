...
- [ ] If the Real-Data Authorization Gate is approved, run a scoped parallel ledger alongside current office records for an agreed period; otherwise reconcile against deterministic fictional fixtures

## Exit criteria
- Authorized parallel pilot reconciles exactly with current office records, or fictional reconciliation passes while the real-data gate remains closed
