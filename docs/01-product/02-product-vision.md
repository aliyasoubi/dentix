...
12. Patient information is fragmented across scheduling, notes, paper forms, spreadsheets, and messaging tools.

13. Long treatments lose momentum because the next action is not visible.

14. Lab-dependent appointments are scheduled before work is ready.

15. Accepted treatment remains unscheduled.

16. Clinical and financial corrections are difficult to audit.

17. Persian interfaces are often translated after design and behave poorly in RTL.

18. Existing systems may be comprehensive but burden small offices with enterprise concepts.
...
Persian and English, RTL/LTR, name scripts, Jalali/Gregorian dates, Iranian contact formats, rial/toman presentation, printed documents, and mixed-script content are designed at the domain and component level.
...
## Success measures for the pilot
  ...
  - Persian and English critical workflows pass the same acceptance suite.
