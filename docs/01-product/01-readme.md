...
This package is the implementation baseline for a custom, browser-based dental practice management system for one dental office. The product is designed for domestic Iranian operation with Persian and English interfaces, first-class Jalali/Gregorian date handling, and unambiguous rial/toman money presentation. It deliberately excludes insurance, claims, payroll, general accounting, native imaging hardware, electronic prescribing, card vaulting, AI diagnosis, native mobile applications, and multi-location central billing.
...
6.  Foundation, security, Iranian bilingual/date/money design system, and patient registry

7.  Scheduling, appointment lifecycle, waitlist, and recall

8.  Encounters, odontogram, notes, and periodontal charting

9.  Treatment planning, journeys, follow-up tasks, and lab orders

10. Patient ledger, receipts, and fixed reports

11. Documents, communications, export, hardening, migration, and pilot
